...
const commands = () => {
  db.dropCollection("screens", function (err) {
    if (err) {
      if (err.code === 26) console.log("-- screens collection does not exists");
      else throw err;
  ...
  db.dropCollection("movies", function (err) {
    if (err) {
      if (err.code === 26) console.log("-- movies collection does not exists");
      else throw err;
  ...
  const movieData = [
    ...
    },
    {
      ...
      img_link:
        "https://m.media-amazon.com/images/M/MV5BMWE2YTBhYzItZDAxZS00Mjc3LWIxNmYtMzljZjIxMGE1NmY2XkEyXkFqcGdeQXVyMjUzOTY1NTc@._V1_.jpg",
    },
    {
      _id: 3,
      id: 3,
      ...
      img_link:
        "https://www.themoviedb.org/t/p/w500/xUuHj3CgmZQ9P2cMaqQs4J0d4Zc.jpg",
    },
    {
      _id: 4,
      id: 4,
      ...
      img_link:
        "https://m.media-amazon.com/images/M/MV5BYjEzN2FlYmYtNDkwMC00NGFkLWE5ODctYmE5NmYxNzE2MmRiXkEyXkFqcGdeQXVyMjMwODc5Mw@@._V1_FMjpg_UX1000_.jpg",
    },
    {
      _id: 5,
      id: 5,
