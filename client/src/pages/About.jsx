        ...
        <div className="row">
            <div className="col">
                <center>
                    ...
                    <p className="primary"> QA cinema was founded by it's five amazing founders Tom Ayling, Jasmin Willis, Guv Mehat, Rayyana Suleiman and Fowsia Bilkeer. 
                    ...
                    <Link to="/contact"><u>here</u></Link>. <br/></p>
                    ...
                    Please do not hesistate to contact us or drop a message in the discussion forum <Link to="/discussion"><u>here</u></Link>.</p>
                </center><br/><br/>
                <Footer/>
