...
function Places() {
  return (
    <div>
      ...
      <br></br>
      <h1>Restaurants</h1>
      <p>Wide selction of restaurants for you to vist during your visit. Use your cinema ticket to get a discount.</p>
      ...
      <div style={{ display: 'flex' }}>
        ...
        <div class="column"><h2>Burger king</h2>
      ...
      <div style={{ display: 'flex' }}>
        ...
        <div class="column"><h2>Hollywood Bowling</h2>
        ...
        <div class="column"><h2>Crazy Golf</h2>
